...
$bn_position = (isset($_GET['bn_position']) && in_array($_GET['bn_position'], array('메인', '왼쪽', '상단','설문'))) ? $_GET['bn_position'] : '';
...
<div class="local_ov01 local_ov">
    ...
    <select name="bn_position" id="bn_position">
        ...
        <option value="설문"<?php echo get_selected($bn_position, '설문', true); ?>>설문</option>
    </select>
