...
add_javascript('<script src="/assets/js/foundation.js"></script>', 0);
add_stylesheet('<link rel="stylesheet" href="'.G5_JS_URL.'/font-awesome/css/font-awesome.min.css">', 0);
//add_stylesheet('<link rel="stylesheet" href="./assets/css/foundation.css">', 0);
add_stylesheet('<link rel="stylesheet" href="/assets/css/foundation-prototype.css">', 0);
