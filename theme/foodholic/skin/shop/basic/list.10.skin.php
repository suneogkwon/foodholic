...
<div class="content">
 <div class="floatwrap">
    ...
    for ($i=1; $row=sql_fetch_array($result); $i++) {
        ...
        echo "<li class=\"sct_li col-row-5 {$sct_last}\">\n";
        ...
        // <button type=\"button\" class=\"btn_cart sct_cart\" data-it_id=\"{$row['it_id']}\"><span class=\"sound_only\">장바구니</span><i class=\"xi-cart-o\"></i></button>";
