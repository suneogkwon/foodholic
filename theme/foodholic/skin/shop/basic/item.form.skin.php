    ...
    <div id="sit_ov_wrap">
        ...
        <section id="sit_ov" class="2017_renewal_itemform">
            ...
            <div id="sit_star_sns">
                ...
                <?php } ?>
                리뷰<strong><?php echo $it['it_use_cnt']; ?></strong>건
            </div>
            <div class="sns_area">
                <a href="javascript:item_wish(document.fitem, '<?php echo $it['it_id']; ?>');" id="sit_btn_wish"><i class="fa fa-heart-o" aria-hidden="true"></i> 위시리스트</a>
                <div class="sns_wr"><?php echo $sns_share_links; ?> 
...
<div id="option_wr">
    <div id="option_cost">
        <?php if (!$it['it_use']) { // 판매가능이 아닐 경우 ?>
        <strong class="color1">
            <i class="fa fa-times"></i> 판매중지
        </strong>
        <?php } else if ($it['it_tel_inq']) { // 전화문의일 경우 ?>
        <strong class="color1">
            <i class="fa fa-phone"></i> 전화문의
        </strong>
        <?php } else { // 전화문의가 아닐 경우?>
        <span>
        ...
        <?php if ($it['it_cust_price']) { ?>
        <span class="cust_price">
            <span class="sound_only">시중가격</span>
