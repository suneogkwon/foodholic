...
for ($i=1; $row=sql_fetch_array($result); $i++) {
    ...
    echo "<li class=\"sct_li col-row-4 {$sct_last}\">\n";

    echo "<div class=\"sct_inner\">\n";
    ...
    if ($this->view_it_img) {
        echo get_it_main_img($row['it_id'], $this->img_width, $this->img_height, '', '', stripslashes($row['it_name']))."\n";
    }
    if ($this->view_it_img && false) {
        echo "<span class=\"sct_img_02\">".get_it_main_img($row['it_id'], $this->img_width, $this->img_height, '', '', stripslashes($row['it_name']))."</span>\n";
    }
    ...
    <button type=\"button\" class=\"btn_cart\" data-it_id=\"{$row['it_id']}\"><span class=\"sound_only\">장바구니</span><i class=\"xi-cart-o\"></i></button>";
    // <button type=\"button\" class=\"btn_wish\" data-it_id=\"{$row['it_id']}\"><span class=\"btn_txt\">위시리스트</span></button>
    // <button type=\"button\" class=\"btn_share\"><span class=\"btn_txt\">sns공유</span></button>\n";
    echo "</div>\n";
