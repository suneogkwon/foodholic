    ...
    <section id="sod_fin_list">
        ...
        <div class="tbl_head03 tbl_wrap">
			<table>
	            ...
	            <?php } ?>
	            <tr>
	                <td headers="th_itopt" class="td_prd" data-th="상품명">
                        <?php if($row['ca_id'] == 10) {?>
                                        <div class="sod_img"><img src="<?php echo G5_THEME_IMG_URL; ?>/default_box.jpg" width="200" height="200" alt=""></div>
                                    <?php } else if($row['ca_id'] == 20){ ?>
                                        <div class="sod_img"><img src="<?php echo G5_THEME_IMG_URL; ?>/default_side.jpg" width="200" height="200" alt=""></div>
                                    <?php } else {?>
	                ...
	                <td headers="th_itqty" class="td_mngsmall" data-th="수량"><?php echo number_format($opt['ct_qty']); ?></td>
	                <td headers="th_itprice" class="td_numbig text_right" data-th="판매가"><?php echo number_format($opt_price); ?></td>
	                <td headers="th_itpt" class="td_numbig text_right" data-th="포인트"><?php echo number_format($point); ?></td>
	                <td headers="th_itsd" class="td_dvr" data-th="배송비"><?php echo $ct_send_cost; ?></td>
	                <td headers="th_itsum" class="td_numbig text_right" data-th="소계"><?php echo number_format($sell_price); ?></td>
	                <td headers="th_itst" class="td_mngsmall" data-th="상태"><?php echo $opt['ct_status']; ?></td>
	            </tr>
	            <?php
	                    $tot_point       += $point;
    ...
    <div class="sod_left">
        ...
        <section id="sod_fin_receiver">
            ...
            <div class="tbl_head01 tbl_wrap">
                ...
                <tr>
                    <th scope="row">공동현관</th>
                    <td><?php echo get_text($od['od_b_addr3']); ?></td>
                </tr>
                <?php
                // 희망배송일을 사용한다면
