    ...
    <div id="sod_bsk" class="od_prd_list">
        ...
        <form name="frmcartlist" id="sod_bsk_list" class="2017_renewal_itemform" method="post" action="<?php echo $cart_action_url; ?>">
                    ...
                    <thead>
                        <tr>
                            <th scope="col">
                                ...
                                <input class="tgl tgl-ios" type="checkbox" name="ct_all" value="1" id="ct_all" checked="checked">
                                <label for="ct_all" class="tgl-btn"></label>
                            </th>
                            <th scope="col">상품명</th>
                            <th scope="col">수량</th>
                            <th scope="col">판매가</th>
                        ...
                        ?>
                            ...
                            <tr>
                                <td class="td_chk" data-th="상품 선택">
                                    ...
                                    <input class="tgl tgl-ios" type="checkbox" name="ct_chk[<?php echo $i; ?>]" value="1" id="ct_chk_<?php echo $i; ?>" checked="checked">
                                    <label for="ct_chk_<?php echo $i; ?>" class="tgl-btn"></label>
                                    </span>
                                </td>
                                ...
                                <td class="td_prd" data-th="상품명">
                                    ...
                                    <div class="sod_name">
                                        ...
                                        <?php echo '<b class="prd_name">'.stripslashes($row['it_name']).'</b>';
                                ...
                                <td class="td_num" data-th="수량">
                                    <span class="bt-content">
                                    <?php
                                    // <a href="#none" onclick="cart_qty_down(<?php echo '1,'.$row['it_id'].','.$row['od_id'])" class="chng_btn"><i class="fas fa-chevron-left"></i></a>
                                    echo number_format($row['ct_qty']);
                                    // <a href="#none" onclick="cart_qty_up(<?php echo '1,'.$row['it_id'].','.$row['od_id'])" class="chng_btn"><i class="fas fa-chevron-right"></i></a>
                                    ?>
                                    </span>
                                </td>
                                ...
                                <td class="td_numbig text_right" data-th="소계">
                                    <span class="bt-content">
                                    <span id="sell_price_<?php echo $i; ?>" class="total_prc"><?php echo number_format($sell_price); ?></span>
                                    </span>
                                </td>
            ...
            <div class="sod_tot_wr">
                ...
                <div id="sod_bsk_act">
                    <?php if ($i == 0) { ?>
                        <a href="<?php echo G5_SHOP_URL; ?>/list.php?ca_id=10" class="btn01">쇼핑 계속하기</a>
                    <?php } else { ?>
