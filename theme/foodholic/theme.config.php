...
$theme_config = array(
    ...
    'bo_gallery_width'              => 500,     // 갤러리 이미지 폭
    'bo_gallery_height'             => 600,     // 갤러리 이미지 높이
    ...
    'de_type1_list_mod'             => 8,       // PC 히트상품 출력 1줄당 이미지 수
    'de_type1_list_row'             => 1,       // PC 히트상품 출력 출력 줄 수
    'de_type1_img_width'            => 335,     // PC 히트상품 이미지 폭
    'de_type1_img_height'           => 480,     // PC 히트상품 이미지 높이
    'de_type2_list_use'             => 1,       // PC 추천상품 출력
    'de_type2_list_skin'            => 'main.50.skin.php', // PC 추천상품 출력스킨
    'de_type2_list_mod'             => 5,       // PC 추천상품 출력 1줄당 이미지 수
    'de_type2_list_row'             => 1,       // PC 추천상품 출력 출력 줄 수
    'de_type2_img_width'            => 70,     // PC 추천상품 이미지 폭
    'de_type2_img_height'           => 70,     // PC 추천상품 이미지 높이
    'de_type3_list_use'             => 1,       // PC 최신상품 출력
    'de_type3_list_skin'            => 'main.20.skin.php', // PC 최신상품 출력스킨
    'de_type3_list_mod'             => 14,       // PC 최신상품 출력 1줄당 이미지 수
    'de_type3_list_row'             => 1,       // PC 최신상품 출력 출력 줄 수
    'de_type3_img_width'            => 160,     // PC 최신상품 이미지 폭
    'de_type3_img_height'           => 160,     // PC 최신상품 이미지 높이
    'de_type4_list_use'             => 1,       // PC 인기상품 출력
    'de_type4_list_skin'            => 'main.10.skin.php', // PC 인기상품 출력스킨
    'de_type4_list_mod'             => 6,       // PC 인기상품 출력 1줄당 이미지 수
    'de_type4_list_row'             => 2,       // PC 인기상품 출력 출력 줄 수
    'de_type4_img_width'            => 269,     // PC 인기상품 이미지 폭
    'de_type4_img_height'           => 269,     // PC 인기상품 이미지 높이
    'de_type5_list_use'             => 1,       // PC 할인상품 출력
    'de_type5_list_skin'            => 'main.40.skin.php', // PC 할인상품 출력스킨
    'de_type5_list_mod'             => 6,       // PC 할인상품 출력 1줄당 이미지 수
    'de_type5_list_row'             => 1,       // PC 할인상품 출력 출력 줄 수
    'de_type5_img_width'            => 175,     // PC 할인상품 이미지 폭
    'de_type5_img_height'           => 175,     // PC 할인상품 이미지 높이
    ...
    'de_mobile_type1_img_width'     => 130,     // 모바일 히트상품 이미지 폭
    'de_mobile_type1_img_height'    => 130,     // 모바일 히트상품 이미지 높이
    'de_mobile_type2_list_use'      => 1,       // 모바일 추천상품 출력
    'de_mobile_type2_list_skin'     => 'main.30.skin.php', // 모바일 추천상품 출력스킨
    ...
    'de_mobile_type5_img_width'     => 130,     // 모바일 할인상품 이미지 폭
    'de_mobile_type5_img_height'    => 130,     // 모바일 할인상품 이미지 높이
    ...
    'de_search_list_skin'           => 'list.20.skin.php',  // 검색상품 출력 스킨
    ...
    'ca_img_width'                  => 330,     // 분류 리스트 이미지 폭
    'ca_img_height'                 => 330,     // 분류 리스트 이미지 높이
    ...
    'ca_list_best_mod'              => 5,       // 상품리스트 베스트상품 1줄당 이미지 수
    'ca_list_best_row'              => 1,       // 상품리스트 베스트상품 이미지 줄 수
