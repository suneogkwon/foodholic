    ...
    for ($i=0; $i<count($_POST['chk']); $i++)
    {
        ...
        if (!$mb['mb_id']) {
            ...
            $sql = " update {$g5['member_table']}
                        ...
                        // mb_intercept_date = '".sql_real_escape_string($_POST['mb_intercept_date'][$k])."',mb_open = '".sql_real_escape_string($_POST['mb_open'][$k])."',mb_certify = '".sql_real_escape_string($_POST['mb_certify'][$k])."',,mb_adult = '{$mb_adult}'
            sql_query($sql);
        }
    }
