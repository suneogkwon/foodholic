...
<h2 class="font-bold padding-2">메뉴 추가</h2>
<!-- 장바구니 옵션 시작 { -->
<form class="padding-2 position-relative" name="foption" method="post" action="<?php echo G5_SHOP_URL; ?>/cartupdate.php" onsubmit="return formcheck(this);">
...
<div id="sit_sel_option">
	<h3 class="show-for-sr">선택옵션</h3>
    <ul id="sit_opt_added" class="no-bullet">
        <?php
        ...
        <li class="sit_<?php echo $cls; ?>_list">
            ...
            <div class="opt_name padding-1 bordered" style="border-bottom:none">
                <span class="sit_opt_subj"><?php echo $row['ct_option']; ?></span>
            </div>
            <div class="opt_count input-group align-middle bordered">
                <button type="button" class="sit_qty_minus input-group-button padding-2"><i class="xi-minus"></i><span class="show-for-sr">감소</span></button>
                <label for="ct_qty_<?php echo $i; ?>" class="show-for-sr">수량</label>
                <input type="text" name="ct_qty[<?php echo $it['it_id']; ?>][]" value="<?php echo $row['ct_qty']; ?>" id="ct_qty_<?php echo $i; ?>" class="num_input input-group-field border-none text-center" style="box-shadow: none;">
                <button type="button" class="sit_qty_plus input-group-button padding-2"><i class="xi-plus"></i><span class="show-for-sr">증가</span></button>
                <span class="sit_opt_prc text-right" style="width:55%;"><?php echo $io_price; ?></span>
                <button type="button" class="sit_opt_del padding-2"><i class="xi-close"></i><span class="show-for-sr">삭제</span></button>
            </div>
        </li>
        <?php
        }
...
<div>
    <button type="submit" class="button expanded padding-1"><span class="h6 margin-0">확인</span></button>
</div>
    <button type="button" id="mod_option_close" class="btn_close position-absolute padding-2 border-none" style="top:-55px;right:10px;"><i class="h3 xi-close margin-0"></i><span class="show-for-sr">닫기</span></button>
</form>
