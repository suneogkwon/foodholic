...
<form name="forderform" id="forderform" class="2017_renewal_itemform" method="post" action="<?php echo $order_action_url; ?>" autocomplete="off">
        ...
        <tr>
            ...
            <td class="td_prd">
                ...
                <div class="sod_name">
                    ...
                    echo $mod_options.$it_name;
                    echo $cp_button; ?>

                </div>
                <?php if($row['ca_id'] == 10 || $row['ca_id'] == 20){ ?> 
                    <div class="sod_explan"><?php echo stripslashes($row['it_explan']) ?>
                <?php } ?>
            </td>
            ...
            <div class="tbl_frm01 tbl_wrap">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn_address" onclick="win_zip('forderform', 'od_zip', 'od_addr1', 'od_addr2', 'od_addr_jibeon');">주소 검색</button><br>
                ...
                <?php if($chk_category) {?>
                <tr>
                    <th scope="row"><label for="od_addr3">수령방법</label></th>
                    <td>
            ...
            <div class="tbl_frm01 tbl_wrap">
                ...
                <tr>
                    ...
                    <td id="sod_frm_addr">
                        ...
                        <button type="button" class="btn_address" onclick="win_zip('forderform', 'od_b_zip', 'od_b_addr1', 'od_b_addr2', 'empty','od_b_addr_jibeon');">주소 검색</button><br>
...
function reload_tot(){
    ...
    var price = parseInt($('#od_tot_price .print_price').text().replace(',',''));
    ...
    $('#od_tot_price .print_price').text(number_format(price + hall_discount));
