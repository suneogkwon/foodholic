...
<div class="content">
    <div class="floatwrap">
<div id="bo_list" class="con_right">
	<!-- 게시판 페이지 정보 및 버튼 시작 { -->
    <div id="bo_btn_top">
    ...
    <div class="bo_fx">
        <ul class="btn_bo_user">
            ...
            <?php } ?>
            <?php if ($list_href && false) { ?><li><a href="<?php echo $list_href ?>" class="btn_b01 btn">목록</a></li><?php } ?>
            <?php if ($write_href && false) { ?><li><a href="<?php echo $write_href ?>" class="btn_b02 btn">문의등록</a></li><?php } ?>
        </ul>
    </div>
    </form>
