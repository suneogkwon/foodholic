...
<section id="bo_w">
    ...
    <div class="write_startend">
        <div>
            <input id="ev_startdate" class="ui-datepicker" type="date" name="wr_1" value="<?php echo $wr_1 ?>" id="wr_1" required placeholder="시작날짜">
            <span> ~ </span>
            <input id="ev_enddate" class="ui-datepicker" type="date" name="wr_2" value="<?php echo $wr_2 ?>" id="wr_2" required placeholder="종료날짜">
        </div>
        <script>
            $( function() {
                $( "#ev_startdate, #ev_enddate" ).datepicker();
