                ...
                <div id="register_form" class="form_01">
                    <div class="register_wr">
                        ...
                        <ul>
                            <li>
                                ...
                                <a href="#none" class="overlap idcheck btn_idcheck">중복확인</a>
                                <span id="msg_mb_id"></span>
                                <p class="frm_info">영문자, 숫자, _ 만 입력 가능. 최소 3자이상 입력하세요.</p>
                            </li>
                            <li>
                                ...
                                <input type="password" name="mb_password_re" id="reg_mb_password_re" <?php echo $required ?> class="frm_input right_input half_input <?php echo $required ?>" minlength="3" maxlength="20" placeholder="비밀번호 확인">
                            </li>
                        </ul>
                    </div>

                    <div class="tbl_frm01 tbl_wrap register_wr">
                        <h2>개인정보 입력</h2>

                        <ul>
                            <li>
                                <label for="reg_mb_name" class="sound_only">이름<strong>필수</strong></label>
                                <input type="text" id="reg_mb_name" name="mb_name" value="<?php echo get_text($member['mb_name']) ?>" <?php echo $required ?> <?php echo $readonly; ?> class="frm_input <?php echo $required ?> <?php echo $readonly ?>" size="20" placeholder="이름">
                                <?php
                            ...
                            <?php if ($req_nick) {  ?>
                                    ...
                                    <input type="text" name="mb_nick" value="<?php echo isset($member['mb_nick']) ? get_text($member['mb_nick']) : ''; ?>" id="reg_mb_nick" required class="frm_input half_input required" size="10" maxlength="20" placeholder="닉네임">
                            ...
                            <?php }  ?>
                                    ...
                                    <input type="text" name="mb_email" value="<?php echo isset($member['mb_email']) ? $member['mb_email'] : ''; ?>" id="reg_mb_email" required class="frm_input email <?php echo ($req_nick)? 'right_input':'left_input'?> half_input required" size="70" maxlength="100" placeholder="E-mail">
                                    <?php if ($req_nick) {  ?>
                                    <span class="frm_info">
                    ...
                    <div class="tbl_frm01 tbl_wrap register_wr">
                        ...
                        <ul>
                            ...
                            <li>
                                <div class="frm_label">메일링서비스</div>
                                <input type="checkbox" name="mb_mailling" value="1" id="reg_mb_mailling" <?php echo ($w == '' || $member['mb_mailling']) ? 'checked' : ''; ?> class="tgl tgl-ios">
                                <label for="reg_mb_mailling" class="tgl-btn"></label>
                                정보 메일을 받겠습니다.
                            </li>

                            <?php if ($config['cf_use_hp']) {  ?>
                                <li>
                                    <div class="frm_label">SMS 수신여부</div>

                                    <input type="checkbox" name="mb_sms" value="1" id="reg_mb_sms" <?php echo ($w == '' || $member['mb_sms']) ? 'checked' : ''; ?> class="tgl tgl-ios">
                                    <label for="reg_mb_sms" class="tgl-btn"></label>
                                    휴대폰 문자메세지를 받겠습니다.
                                </li>
                            <?php }  ?>
