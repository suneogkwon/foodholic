...
<section id="poll">
    ...
    <div class="poll_innr">
	    <div class="poll_con">
	        ...
	        <div id="poll_btn">
	            <button type="submit" class="btn_poll btn_b02 btn">투표하기</button>
	            <a href="<?php echo G5_BBS_URL."/poll_result.php?po_id=$po_id&amp;skin_dir=".urlencode($skin_dir); ?>" target="_blank" onclick="poll_result(this.href); return false;" class="btn_result btn_poll btn btn_b01">결과보기</a>
	        </div>
	    </div>
    </div>
</section>
